...
class bam:
    ...
    def call_variants(self,caller="GATK",gff_file=None,bed_file=None,call_method="optimise",min_dp=10,max_dp=None,threads=4,mixed_as_missing=False,low_dp_as_missing=True,af=0.0,whole_genome=False,**kwargs):
        add_arguments_to_self(self,locals())
